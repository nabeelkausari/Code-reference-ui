...
exports.default = ({ title, hiddenMessage, body, senderName, senderDesignation, senderPhone }) => `
<!DOCTYPE html>
<html>
<head>
    <title>${title}</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
                            <tr>
                                <td align="center" valign="top" style="padding: 40px 10px 30px 10px;">
                                    <a href="http://bidable.in" target="_blank">
                                        <img alt="Bidable" src="http://bidable.in/static/img/bidable-email.png" style="display: block; width: 200px; max-width: 200px; min-width: 40px; font-family: 'Rubik', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
                                    </a>
                                </td>
                            </tr>
                        </table>
                ...
                <!-- COPY -->
                            ...
                            <tr>
                                <td bgcolor="#ffffff" align="left" valign="top" style="border-bottom: 5px solid #FECB00; padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Rubik', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                                    <p style="margin: 0;">With Best Regards,<br>${senderName},<br>${senderDesignation},<br>Bidable.in, <br>Phone: ${senderPhone}</p>
                                </td>
                            </tr>
                        </table>
            ...
            <table style="display: block; max-width: 600px" border="0" cellpadding="0" cellspacing="0" width="100%" >
                ...
                <tr>
                    <td bgcolor="#f4f4f4" align="left" style="padding: 30px 30px 30px 30px; color: #666666; font-family: 'Rubik', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; line-height: 18px;" >
                        <p style="margin: 0;"><b>Bidable.in</b> - <b>Zecta Technologies Pvt Ltd</b>, 208-D, 80 feet road, HBR Extension, 1st stage, 2nd Block, Bengaluru 43</p>
                    </td>
                </tr>
            </table>

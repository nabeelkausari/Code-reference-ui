...
exports.default = ({ title, hiddenMessage, body }) => `
<!DOCTYPE html>
<html>
<head>
    <title>${title}</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
                            <tr>
                                <td align="center" valign="top" style="padding: 10px;">
                                    <a href="https://www.alimbook.com" target="_blank">
                                        <img alt="Alimbook" src="http://localhost:3000/static/alimbook-full.png" style="display: block; width: 300px; max-width: 300px; min-width: 40px; font-family: 'Rubik', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
                                    </a>
                                </td>
                            </tr>
                        </table>

...
export default ({ title, hiddenMessage, message, actionTitle, actionUrl }) => `
<!DOCTYPE html>
<html>
<head>
    <title>${title}</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
                            <tr>
                                <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Rubik', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 500; line-height: 48px; text-transform: capitalize;">
                                    <h1 style="font-size: 28px; font-weight: 500; margin: 0;">${title}</h1>
                                </td>
                            </tr>
                        </table>
            <!--[if (gte mso 9)|(IE)]>
                                        ...
                                        <tr>
                                            <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td align="center" style="border-radius: 3px;" bgcolor="#FECB00"><a href="${actionUrl}" target="_blank" style="font-size: 20px; font-family: 'Rubik', Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #000; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #fc0; display: inline-block;">${actionTitle}</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
